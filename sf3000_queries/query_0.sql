...
select  i_item_id
 ...
 and d_date between cast('2002-06-22' as date) and (cast('2002-06-22' as date) + interval 60 days)
...
where 
	...
	and d_date between cast('2001-03-17' as date) 
				and (cast('2001-03-17' as date) + interval 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-04-05' as date) and (cast('2002-04-05' as date) + interval 60 days)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2000-08-02' as date) 
                  and (cast('2000-08-02' as date) + interval 30 days)
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-11' as date) 
                  and (cast('1998-08-11' as date) + interval 14 days)
