...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-09' as date) 
                  and (cast('2001-08-09' as date) + interval 14 days)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-11' as date) 
                  and (cast('1999-08-11' as date) + interval 30 days)
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-03-25' as date) - interval 30 days)
                    and (cast ('2000-03-25' as date) + interval 30 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-02-07' as date) and (cast('2000-02-07' as date) + interval 60 days)
...
and d_date between '2001-02-25' and 
        (cast('2001-02-25' as date) + interval 90 days)
...
and d_date between '2001-03-31' and 
        (cast('2001-03-31' as date) + interval 90 days)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1998-08-25' as date) 
                  and (cast('1998-08-25' as date) + interval 30 days)
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
