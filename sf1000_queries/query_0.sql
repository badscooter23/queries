...
and d_date between '2001-01-26' and 
        (cast('2001-01-26' as date) + interval 90 days)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-29' as date) 
                  and (cast('1999-08-29' as date) + interval 30 days)
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-05-10' as date) - interval 30 days)
                and (cast ('2002-05-10' as date) + interval 30 days)
 group by
    w_state,i_item_id
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-19' as date) 
                  and (cast('2001-08-19' as date) + interval 14 days)
