...
where 
	...
	and d_date between cast('2002-06-21' as date) 
				and (cast('2002-06-21' as date) + interval 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-04' as date) 
                  and (cast('2000-08-04' as date) + interval 14 days)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-14' as date) 
                  and (cast('2001-08-14' as date) + interval 30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-10' as date) 
                  and (cast('2002-08-10' as date) + interval 30 days)
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
select  i_item_id
 ...
 and d_date between cast('1999-06-21' as date) and (cast('1999-06-21' as date) + interval 60 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-02-22' as date) and (cast('2000-02-22' as date) + interval 60 days)
...
where 
	...
	and d_date between cast('2001-05-30' as date) 
				and (cast('2001-05-30' as date) + interval 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '2001-03-21' and 
        (cast('2001-03-21' as date) + interval 90 days)
...
and d_date between '2000-02-16' and 
        (cast('2000-02-16' as date) + interval 90 days)
