...
where 
	...
	and d_date between cast('1998-06-04' as date) 
				and (cast('1998-06-04' as date) + interval 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-05' as date) 
                  and (cast('1998-08-05' as date) + interval 14 days)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2001-08-08' as date) 
                  and (cast('2001-08-08' as date) + interval 30 days)
       and ss_store_sk = s_store_sk
       and ss_item_sk = i_item_sk
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2001-03-07' as date) - interval 30 days)
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-04-10' as date) - interval 30 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-01-29' as date) and (cast('1999-01-29' as date) + interval 60 days)
...
select  i_item_id
 ...
 and d_date between cast('1998-04-22' as date) 
 				and (cast('1998-04-22' as date) + interval 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
and d_date between '1998-02-16' and 
        (cast('1998-02-16' as date) + interval 90 days)
