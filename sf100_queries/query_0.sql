...
select  i_item_id
 ...
 and d_date between cast('2000-03-27' as date) and (cast('2000-03-27' as date) + interval 60 days)
...
where 
	...
	and d_date between cast('2002-02-22' as date) 
				and (cast('2002-02-22' as date) + interval 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '2000-03-20' and 
        (cast('2000-03-20' as date) + interval 90 days)
...
where 
	...
	and d_date between cast('2000-03-01' as date) 
				and (cast('2000-03-01' as date) + interval 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and d_date between cast('1999-02-11' as date) 
 				and (cast('1999-02-11' as date) + interval 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-03-23' as date) and (cast('2002-03-23' as date) + interval 60 days)
