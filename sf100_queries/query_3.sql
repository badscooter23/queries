...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-08' as date) 
                  and (cast('2002-08-08' as date) + interval 14 days)
...
select  i_item_id
 ...
 and d_date between cast('1999-03-25' as date) and (cast('1999-03-25' as date) + interval 60 days)
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-04-18' as date) and (cast('2002-04-18' as date) + interval 60 days)
...
and d_date between '2001-03-24' and 
        (cast('2001-03-24' as date) + interval 90 days)
...
with ss as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-08' as date) 
                  and (cast('2002-08-08' as date) + interval 30 days)
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
