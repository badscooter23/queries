...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-20' as date) 
                  and (cast('2002-08-20' as date) + interval 14 days)
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-23' as date) 
                  and (cast('2002-08-23' as date) + interval 30 days)
...
select  i_item_id
 ...
 and d_date between cast('1998-01-09' as date) and (cast('1998-01-09' as date) + interval 60 days)
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-03-02' as date) - interval 30 days)
                    and (cast ('2000-03-02' as date) + interval 30 days)
...
where 
	...
	and d_date between cast('1999-02-21' as date) 
				and (cast('1999-02-21' as date) + interval 30 days)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between '2001-02-09' and 
        (cast('2001-02-09' as date) + interval 90 days)
...
select  i_item_id
 ...
 and d_date between cast('2001-01-29' as date) 
 				and (cast('2001-01-29' as date) + interval 30 days)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
